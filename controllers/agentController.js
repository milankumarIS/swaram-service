...
const SAFE_FIELDS = [
  ...
  "llm_provider", "llm_model", "system_prompt", "welcome_message",
  "stt_language_code", "tts_voice", "tts_language_code",
  "max_call_duration_sec", "allowed_domains", "embed_token",
...
exports.createAgent = async (req, res, next) => {
  try {
    ...
    const {
      name, llm_model, llm_api_key, system_prompt,
      welcome_message, sarvam_api_key,
      stt_language_code, tts_voice, tts_language_code,
      max_call_duration_sec, allowed_domains,
    } = req.body;
    ...
    const sarvam_api_key_enc = sarvam_api_key ? encryptApiKey(sarvam_api_key) : null;
...
exports.updateAgent = async (req, res, next) => {
  try {
    ...
    const {
      ...
      welcome_message, sarvam_api_key,
      stt_language_code, tts_voice, tts_language_code,
      max_call_duration_sec, allowed_domains, is_active,
    } = req.body;

    const updates = {};
    if (name !== undefined) updates.name = name;
    if (llm_model !== undefined) updates.llm_model = llm_model;
    if (llm_api_key !== undefined) updates.llm_api_key_enc = encryptApiKey(llm_api_key);
    if (system_prompt !== undefined) updates.system_prompt = system_prompt;
    if (welcome_message !== undefined) updates.welcome_message = welcome_message;
    if (sarvam_api_key !== undefined) updates.sarvam_api_key_enc = encryptApiKey(sarvam_api_key);
    if (stt_language_code !== undefined) updates.stt_language_code = stt_language_code;
    if (tts_voice !== undefined) updates.tts_voice = tts_voice;
    if (tts_language_code !== undefined) updates.tts_language_code = tts_language_code;
    if (max_call_duration_sec !== undefined) updates.max_call_duration_sec = max_call_duration_sec;
